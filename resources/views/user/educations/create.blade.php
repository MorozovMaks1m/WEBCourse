<x-main-page-layout title="Create New Education">
    <form
        action="{{ route('user.educations.store') }}"
        method="POST" 
    ...
    >
        ...
        <div class="flex justify-end items-center space-x-4">
            <a href="{{ route('user.educations.index') }}" class="text-gray-600 hover:text-gray-800">
                Undo
            </a>
            <button 
                type="submit" 
